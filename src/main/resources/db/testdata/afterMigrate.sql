...
restaurante_usuario_responsavel write, usuario write,
usuario_grupo write, pedido write, item_pedido write;
...
(1, 'João da Silva', 'joao.ger@algafood.com', '$2a$12$wwZPNEBvA0wI7MbT.p/sOOp35vigXmzNwcO/u7MpRsBdkV2xsXbgy', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '$2a$12$wwZPNEBvA0wI7MbT.p/sOOp35vigXmzNwcO/u7MpRsBdkV2xsXbgy', utc_timestamp),
(3, 'José Souza', 'lucastieni+jose@algafood.com', '$2a$12$wwZPNEBvA0wI7MbT.p/sOOp35vigXmzNwcO/u7MpRsBdkV2xsXbgy', utc_timestamp),
(4, 'Sebastião Martins', 'lucastieni+sebastiao@algafood.com', '$2a$12$wwZPNEBvA0wI7MbT.p/sOOp35vigXmzNwcO/u7MpRsBdkV2xsXbgy', utc_timestamp),
(5, 'Manoel Lima', 'lucastieni@gmail.com', '$2a$12$wwZPNEBvA0wI7MbT.p/sOOp35vigXmzNwcO/u7MpRsBdkV2xsXbgy', utc_timestamp);
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
	                status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, 'd178b637-a785-4768-a3cb-aa1ce5a8cdab', 4, 5, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
	                status, data_criacao, data_confirmacao, data_entrega, subtotal, taxa_frete, valor_total)
values (4, '5c621c9a-ba61-4454-8631-8aabefe58dc2', 1, 5, 1, 1, '38400-800', 'Rua Fortaleza', '900', 'Apto 504', 'Centro',
