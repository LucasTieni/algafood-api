...
public class Restaurante {
	...
	public boolean removeUser(Usuario user) {
		return getResponsaveis().remove(user);
	}
	
	public boolean removePaymentMode(FormaPagamento formaPagamento) {
		return getFormasPagamento().remove(formaPagamento);
	}
	
	public boolean addPaymentMode(FormaPagamento formaPagamento) {
